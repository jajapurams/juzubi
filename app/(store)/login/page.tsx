  ...
  return (
    <div className="mx-auto flex max-w-md flex-col px-4 py-14">
      ...
      <p className="mt-1 text-sm text-neutral-500">
        {mode === "login" ? "Welcome back to Juzubi." : "Join Juzubi to save your wishlist and track enquiries."}
      </p>
      ...
      >
        {mode === "login" ? "New to Juzubi? Create an account" : "Already have an account? Sign in"}
      </button>
    </div>
  );
}
